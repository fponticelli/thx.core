...
class Arrays {
	...
	**/
	 ...
	 */
	public static function zip5Ap<A, B, C, D, E, F>(f:A->B->C->D->E->F, ax:ReadonlyArray<A>, bx:ReadonlyArray<B>, cx:ReadonlyArray<C>, dx:ReadonlyArray<D>,
			ex:ReadonlyArray<E>):Array<F>

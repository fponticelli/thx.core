...
class Convert {
		...
		switch Type.typeof(value) {
			...
			case TClass(c):
				switch Type.getClassName(c) {
					...
					default:
						if (Maps.isMap(value)) return try Json.stringify(Maps.toObject(value)) catch (e:Dynamic)
							throw new Error('unable to convert object to String'); else return throw new Error('unable to convert $value to String');
				}
			case _:
	...
	public static function toDate(value:Dynamic):Date {
		...
		return switch Types.valueTypeToString(value) {
			...
			case "String":
				try Date.fromString((value : String)) catch (e:Dynamic) throw new Error('unable to convert string $value to Date');
			case "Date":
				(value : Date);
			case _:
	...
	public static function toDateTime(value:Dynamic):Null<DateTime> {
		...
		return switch Types.valueTypeToString(value) {
			...
			case "String":
				try DateTime.fromString((value : String)) catch (e:Dynamic) throw new Error('unable to convert string $value to DateTime');
			case "Date":
				(value : Date);
			case _:
	...
	public static function toDateTimeUtc(value:Dynamic):Null<DateTimeUtc> {
		...
		return switch Types.valueTypeToString(value) {
			...
			case "String":
				try DateTimeUtc.fromString((value : String)) catch (e:Dynamic) throw new Error('unable to convert string $value to DateTimeUtc');
			case "Date":
				(value : Date);
			case _:

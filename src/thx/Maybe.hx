...
abstract Maybe<T>(Null<T>) from Null<T> {
	...
	**/
	...
	inline static public function ap4<A, B, C, D, E>(f:A->B->C->D->E, v1:Maybe<A>, v2:Maybe<B>, v3:Maybe<C>, v4:Maybe<D>):Maybe<E>
		return v4.ap(ap3(Functions4.curry(f), v1, v2, v3));

	inline static public function ap5<A, B, C, D, E, F>(f:A->B->C->D->E->F, v1:Maybe<A>, v2:Maybe<B>, v3:Maybe<C>, v4:Maybe<D>, v5:Maybe<E>):Maybe<F>
		return v5.ap(ap4(Functions5.curry(f), v1, v2, v3, v4));

	inline static public function ap6<A, B, C, D, E, F, G>(f:A->B->C->D->E->F->G, v1:Maybe<A>, v2:Maybe<B>, v3:Maybe<C>, v4:Maybe<D>, v5:Maybe<E>,
			v6:Maybe<F>):Maybe<G>
		return v6.ap(ap5(Functions6.curry(f), v1, v2, v3, v4, v5));

	inline static public function ap7<A, B, C, D, E, F, G, H>(f:A->B->C->D->E->F->G->H, v1:Maybe<A>, v2:Maybe<B>, v3:Maybe<C>, v4:Maybe<D>, v5:Maybe<E>,
			v6:Maybe<F>, v7:Maybe<G>):Maybe<H>
		return v7.ap(ap6(Functions7.curry(f), v1, v2, v3, v4, v5, v6));

	inline static public function ap8<A, B, C, D, E, F, G, H, I>(f:A->B->C->D->E->F->G->H->I, v1:Maybe<A>, v2:Maybe<B>, v3:Maybe<C>, v4:Maybe<D>, v5:Maybe<E>,
			v6:Maybe<F>, v7:Maybe<G>, v8:Maybe<H>):Maybe<I>
	...
	inline static public function combine6<A, B, C, D, E, F>(a:Maybe<A>, b:Maybe<B>, c:Maybe<C>, d:Maybe<D>, e:Maybe<E>,
			f:Maybe<F>):Maybe<Tuple6<A, B, C, D, E, F>>

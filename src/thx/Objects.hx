...
class Objects {
	...
	**/
	public static function tuples(o:{}):Array<Tuple2<String, Dynamic>>
		return Reflect.fields(o).map(function(key) return new Tuple2(key, Reflect.field(o, key)));
	...
	**/
	public static function parsePath<T>(o:{}, path:String, parse:Dynamic->Validation.VNel<String, T>):Validation.VNel<String, T>
		return Options.toSuccessNel(getPathOption(o, path), 'Object does not contain path $path').flatMapV(parse);

...
class Options {
	...
	**/
	...
	inline static public function ap4<A, B, C, D, E>(f:A->B->C->D->E, v1:Option<A>, v2:Option<B>, v3:Option<C>, v4:Option<D>):Option<E>
		return ap(v4, ap3(Functions4.curry(f), v1, v2, v3));

	inline static public function ap5<A, B, C, D, E, F>(f:A->B->C->D->E->F, v1:Option<A>, v2:Option<B>, v3:Option<C>, v4:Option<D>, v5:Option<E>):Option<F>
		return ap(v5, ap4(Functions5.curry(f), v1, v2, v3, v4));

	inline static public function ap6<A, B, C, D, E, F, G>(f:A->B->C->D->E->F->G, v1:Option<A>, v2:Option<B>, v3:Option<C>, v4:Option<D>, v5:Option<E>,
			v6:Option<F>):Option<G>
		return ap(v6, ap5(Functions6.curry(f), v1, v2, v3, v4, v5));

	inline static public function ap7<A, B, C, D, E, F, G, H>(f:A->B->C->D->E->F->G->H, v1:Option<A>, v2:Option<B>, v3:Option<C>, v4:Option<D>, v5:Option<E>,
			v6:Option<F>, v7:Option<G>):Option<H>
		return ap(v7, ap6(Functions7.curry(f), v1, v2, v3, v4, v5, v6));

	inline static public function ap8<A, B, C, D, E, F, G, H, I>(f:A->B->C->D->E->F->G->H->I, v1:Option<A>, v2:Option<B>, v3:Option<C>, v4:Option<D>,
			v5:Option<E>, v6:Option<F>, v7:Option<G>, v8:Option<H>):Option<I>
	...
	inline static public function combine6<A, B, C, D, E, F>(a:Option<A>, b:Option<B>, c:Option<C>, d:Option<D>, e:Option<E>,
			f:Option<F>):Option<Tuple6<A, B, C, D, E, F>>

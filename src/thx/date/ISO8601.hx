...
class ISO8601
{
  ...
  {
    if(t.length == 5)
      return { hour : Std.parseInt(t.substr(0,2)), minute : Std.parseInt(t.substr(3)) };
    else if(t.length == 4)
      return { hour : Std.parseInt(t.substr(0,2)), minute : Std.parseInt(t.substr(2)) };
    else if(t.length == 2)
      return { hour : Std.parseInt(t) };
    else
      return throw 'invalid time zone offset: $t';
  }

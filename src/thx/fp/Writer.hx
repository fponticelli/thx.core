...
abstract Writer<W, A>(Tuple3<Monoid<W>, W, A>) {
	...
	static public function ap4<W, A, B, C, D, E>(f:A->B->C->D->E, s1:Writer<W, A>, s2:Writer<W, B>, s3:Writer<W, C>, s4:Writer<W, D>):Writer<W, E>
		return s4.ap(ap3(f.curry(), s1, s2, s3));

	static public function ap5<W, A, B, C, D, E, F>(f:A->B->C->D->E->F, s1:Writer<W, A>, s2:Writer<W, B>, s3:Writer<W, C>, s4:Writer<W, D>,
			s5:Writer<W, E>):Writer<W, F>
		return s5.ap(ap4(f.curry(), s1, s2, s3, s4));

	static public function ap6<W, A, B, C, D, E, F, G>(f:A->B->C->D->E->F->G, s1:Writer<W, A>, s2:Writer<W, B>, s3:Writer<W, C>, s4:Writer<W, D>,
			s5:Writer<W, E>, s6:Writer<W, F>):Writer<W, G>
		return s6.ap(ap5(f.curry(), s1, s2, s3, s4, s5));

	static public function ap7<W, A, B, C, D, E, F, G, H>(f:A->B->C->D->E->F->G->H, s1:Writer<W, A>, s2:Writer<W, B>, s3:Writer<W, C>, s4:Writer<W, D>,
			s5:Writer<W, E>, s6:Writer<W, F>, s7:Writer<W, G>):Writer<W, H>
		return s7.ap(ap6(f.curry(), s1, s2, s3, s4, s5, s6));

	static public function ap8<W, A, B, C, D, E, F, G, H, I>(f:A->B->C->D->E->F->G->H->I, s1:Writer<W, A>, s2:Writer<W, B>, s3:Writer<W, C>, s4:Writer<W, D>,
			s5:Writer<W, E>, s6:Writer<W, F>, s7:Writer<W, G>, s8:Writer<W, H>):Writer<W, I>

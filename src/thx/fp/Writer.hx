...
abstract Writer<W, A> (Tuple3<Monoid<W>, W, A>) {
  ...
  inline public function ap<B>(s2: Writer<W, A -> B>): Writer<W, B>
  ...
  inline static public function ap2<W, A, B, C>(f: A -> B -> C, s1: Writer<W, A>, s2: Writer<W, B>): Writer<W, C>
    return s2.ap(s1.map(f.curry()));

  inline static public function ap3<W, A, B, C, D>(f: A -> B -> C -> D, s1: Writer<W, A>, s2: Writer<W, B>, s3: Writer<W, C>): Writer<W, D>
    return s3.ap(ap2(f.curry(), s1, s2));

  inline static public function ap4<W, A, B, C, D, E>(
      f: A -> B -> C -> D -> E,
      s1: Writer<W, A>, s2: Writer<W, B>, s3: Writer<W, C>, s4: Writer<W, D>): Writer<W, E>
    return s4.ap(ap3(f.curry(), s1, s2, s3));

  inline static public function ap5<W, A, B, C, D, E, F>(
      f: A -> B -> C -> D -> E -> F,
      s1: Writer<W, A>, s2: Writer<W, B>, s3: Writer<W, C>, s4: Writer<W, D>, s5: Writer<W, E>): Writer<W, F>
    return s5.ap(ap4(f.curry(), s1, s2, s3, s4));

  inline static public function ap6<W, A, B, C, D, E, F, G>(
      f: A -> B -> C -> D -> E -> F -> G,
  ...
  inline static public function ap7<W, A, B, C, D, E, F, G, H>(
      f: A -> B -> C -> D -> E -> F -> G -> H,
  ...
  inline static public function ap8<W, A, B, C, D, E, F, G, H, I>(
      f: A -> B -> C -> D -> E -> F -> G -> H -> I,

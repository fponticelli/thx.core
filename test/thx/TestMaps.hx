...
class TestMaps extends utest.Test {
	...
	public function testMerge() {
		var map1 = ["key1" => 1, "key2" => 1, "key3" => 1,];
		var map2 = ["key2" => 2, "key3" => 2,];
		var map3 = ["key3" => 3,];

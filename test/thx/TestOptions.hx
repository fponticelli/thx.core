...
class TestOptions {
  ...
  public function testCataLazy() {
    Assert.same(9, Some(10).cataLazy(function() return 0, function(v) return v - 1));
    Assert.same(0, None.cataLazy(function() return 0, function(v) return v - 1));
  }
  ...
  public function testFoldLeftLazy() {
    Assert.same(-9, Some(10).foldLeftLazy(function() return 1, function(acc, v) return acc - v));
    Assert.same(1, None.foldLeftLazy(function() return 1, function(acc, v) return acc - v));
  }
}

...
class TestStrings extends utest.Test {
	...
	public function testWrapColumn() {
		...
		Assert.equals("Lorem ipsum dolor
sit amet,
consectetur
adipisicing elit,
sed do eiusmod
...
laboris nisi ut
aliquip ex ea
commodo consequat.", text.wrapColumns(20));

		Assert.equals("    Lorem ipsum
    dolor sit amet,
    consectetur
    adipisicing
    elit, sed do

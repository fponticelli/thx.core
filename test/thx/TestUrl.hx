...
class TestUrl extends utest.Test {
	public function testBasics() {
		...
		Assert.isTrue("/some/path/name.ext?a=b&c=d" == url.path || "/some/path/name.ext?c=d&a=b" == url.path);
	...
	public function testToString() {
		var urls:Array<String> = [
			"http://user:password@www.example.com:8888/some/path/name.ext?a=b#hashtag/is/here", "http://example.com", "irc://irc.example.com/channel",
			"www.example.com/foo", "news:rec.gardens.roses", "ldap://[2001:db8::7]/c=GB?objectClass?one", "mailto:John.Doe@example.com",
			"telnet://192.0.2.16:80/", "ldap://ldap.example.com/dc=example,dc=com",

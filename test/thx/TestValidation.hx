...
class TestValidation extends utest.Test {
	...
	public function testAp() {
		...
		var rbi:Validation<Int, Bool->Int> = Right(function(b:Bool) {
	...
	public function testAppendVNels() {
		...
		var errorItems:Array<VNel<String, Int>> = [
			Left(Nel.pure("item error 1")),
			Right(4),
			Left(Nel.pure("item error 2")),
			Right(5)
		];

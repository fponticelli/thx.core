...
class TestDynamics extends utest.Test {
	...
	public function testParseTuple4() {
		Assert.same(Right(Tuple4.of("a", 1, true, 0.1)), thx.fp.Dynamics.parseTuple4({
			_0: "a",
			_1: 1,
			_2: true,
			_3: 0.1
		}, parseString, parseInt, parseBool, parseFloat, identity));
	...
	public function testParseTuple5() {
		Assert.same(Right(Tuple5.of("a", 1, true, 0.1, "B")), thx.fp.Dynamics.parseTuple5({
			_0: "a",
			_1: 1,
			_2: true,
			_3: 0.1,
			_4: "B"
		}, parseString, parseInt, parseBool, parseFloat, parseString, identity));
	...
	public function testParseTuple6() {
		Assert.same(Right(Tuple6.of("a", 1, true, 0.1, "B", -1)), thx.fp.Dynamics.parseTuple6({
			_0: "a",
			_1: 1,
			_2: true,
			_3: 0.1,
			_4: "B",
			_5: -1
		}, parseString, parseInt, parseBool, parseFloat, parseString, parseInt,
			identity));

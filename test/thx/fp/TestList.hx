...
class TestList extends utest.Test {
	...
	public function testZip5Ap() {
		...
		Assert.same(List.fromArray(["a1x3true", "b2y4false"]),
			List.zip5Ap(function(s:String, i:Int, t:String, j:Int, b:Bool) return '$s$i$t$j$b', sx, ix, tx, jx, bx));
	}
}
